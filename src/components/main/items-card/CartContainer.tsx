  ...
  const totalPrice = cart
    .flatMap((item) =>
      item.products.flatMap((product) =>
        product.products.map((prod) => parseFloat(prod.price) * item.quantity)
      )
    )
      ...
      <div className="carrito" id="carrito">
        <div className="carrito__contenedor">
              ...
              {cart.flatMap((item, itemIndex) =>
                item.products.flatMap((product) =>
                  product.products.map((prod) => (
                    <div className="carrito__producto" key={prod.id}>
                      ...
                      <div className="carrito__producto-contenedor-precio">
                        ...
                        <p className="carrito__total">
                          Precio Total:{" "}
                          {(parseFloat(prod.price) * item.quantity).toLocaleString("en-US", {
                            style: "currency",
                            currency: "USD",
                          })}
                        </p>
          ...
          <div className="carrito__footer">
            ...
            >
              <button type="button" className="carrito__btn-regresar">
